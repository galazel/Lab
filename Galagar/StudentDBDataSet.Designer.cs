...
namespace Galagar {
    ...
    public partial class StudentDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentsRow AddStudentsRow(string FirstName, string LastName, int Age, string Course) {
...
namespace Galagar.StudentDBDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([StudentID] = @Original_StudentID) AND ([Fir" +
                "stName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Age] " +
                "= @Original_Age) AND ([Course] = @Original_Course))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([FirstName], [LastName], [Age], [Course]) VALUES (@" +
                "FirstName, @LastName, @Age, @Course);\r\nSELECT StudentID, FirstName, LastName, Ag" +
                "e, Course FROM Students WHERE (StudentID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [FirstName] = @FirstName, [LastName] = @LastName, [Age] = @Age, [Course] = @Course WHERE (([StudentID] = @Original_StudentID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Age] = @Original_Age) AND ([Course] = @Original_Course));
SELECT StudentID, FirstName, LastName, Age, Course FROM Students WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Galagar.Properties.Settings.Default.StudentDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_StudentID, string Original_FirstName, string Original_LastName, int Original_Age, string Original_Course) {
        ...
        public virtual int Insert(string FirstName, string LastName, int Age, string Course) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, int Age, string Course, int Original_StudentID, string Original_FirstName, string Original_LastName, int Original_Age, string Original_Course, int StudentID) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, int Age, string Course, int Original_StudentID, string Original_FirstName, string Original_LastName, int Original_Age, string Original_Course) {
            return this.Update(FirstName, LastName, Age, Course, Original_StudentID, Original_FirstName, Original_LastName, Original_Age, Original_Course, Original_StudentID);
        }
    }
